...
public abstract class ProductFavoriteBase<M extends ProductFavoriteBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setCollectDate(Date var) {
        set(Fields.COLLECT_DATE.toString(), var);
    }

    public Date getCollectDate() {
        return (Date) get(Fields.COLLECT_DATE.toString());
    }
