...
public abstract class ProductPropertyBase<M extends ProductPropertyBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setPropertyId(Integer var) {
        set(Fields.PROPERTY_ID.toString(), var);
    }

    public Integer getPropertyId() {
        return (Integer) get(Fields.PROPERTY_ID.toString());
    }

    public void setPropertyValue(String var) {
        set(Fields.PROPERTY_VALUE.toString(), var);
    }

    public String getPropertyValue() {
        return (String) get(Fields.PROPERTY_VALUE.toString());
    }
