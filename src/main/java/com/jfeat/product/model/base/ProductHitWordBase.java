...
public abstract class ProductHitWordBase<M extends ProductHitWordBase<?>> extends BaseModel<M> implements IBean {
    ...
    public void setHit(Integer var) {
        set(Fields.HIT.toString(), var);
    }

    public Integer getHit() {
        return (Integer) get(Fields.HIT.toString());
    }
